...
abstract class Admin implements Plugin
{
    ...
    public static function getInfo()
    {
        return array(
            ...
            'permanent' => true,
            // true if module is permanent and thus not uninstallable (3rd party modules should specify 'false')
            'permission' => '',
            // name of permission required to execute this Process (optional)
        );
    }
